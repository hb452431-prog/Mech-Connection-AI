...
// Standalone SVG Emblem component for headers, splash screens, and avatars
export const BrandEmblem = ({ size = 44, className = '' }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 200 200"
    ...
    className={`flex-shrink-0 drop-shadow-sm transition-transform duration-300 ${className}`}
  >
    <defs>
