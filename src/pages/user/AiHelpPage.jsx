  ...
  return (
    <div className="min-h-screen bg-[#F6F8FC] dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 flex flex-col pb-24 md:pb-12 transition-colors duration-200">
      ...
      <main className="max-w-2xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-8 space-y-6">
        ...
        <div className="clean-card p-6 sm:p-7 space-y-5 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm">
          <form onSubmit={handleAnalyze} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1">
                <span className="text-[11px] font-semibold text-slate-400 dark:text-slate-500">Quick examples:</span>
            ...
            <div className="pt-3 border-t border-slate-100 dark:border-slate-800 space-y-2">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                ...
                {imageFile && (
                  <span className="text-xs text-slate-600 dark:text-slate-300 font-medium bg-slate-100 dark:bg-slate-800 px-3 py-1.5 rounded-lg truncate max-w-xs">
                    📎 {imageFile.name}
                  </span>
                )}
              </div>
              ...
              {imagePreview && (
                <div className="mt-2 relative w-32 h-24 rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-xs">
        ...
        {analysisResult && (
          <div className="clean-card p-6 sm:p-7 space-y-6 border-l-4 border-l-indigo-600 animate-in fade-in duration-200 shadow-md bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800">
            ...
            <div className="space-y-2">
              ...
              <div>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-semibold uppercase font-mono">Problem:</p>
              ...
              <div className="space-y-2.5">
                {analysisResult.steps.map((step, idx) => (
                  <div key={idx} className="p-3.5 bg-slate-50 dark:bg-slate-800/80 rounded-xl flex items-start gap-3 border border-slate-100 dark:border-slate-800">
                    ...
                    <div>
                      <span className="text-xs font-bold text-slate-700 dark:text-slate-300 block">Step {idx + 1}:</span>
