  ...
  return (
    <div className="min-h-screen bg-[#F6F8FC] dark:bg-[#080D1A] text-slate-900 dark:text-slate-100 flex flex-col pb-28 sm:pb-32 md:pb-16 transition-colors duration-200">
      ...
      <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 py-8 sm:py-12 md:py-14 space-y-8 sm:space-y-10">
          ...
          <div className="clean-card emergency-card-active p-7 sm:p-10 space-y-8 sm:space-y-9 shadow-xl rounded-3xl border-2 border-orange-200 dark:border-orange-900/60 bg-white dark:bg-slate-900">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="block text-xs sm:text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider font-mono flex items-center gap-2.5">
                  <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-950 flex items-center justify-center text-xs font-black shadow-xs">1</span>
                  <span>Select Vehicle Type:</span>
                </label>
                <span className="text-[11px] font-mono text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-50 dark:bg-emerald-950/60 px-3 py-1 rounded-full border border-emerald-200 dark:border-emerald-800">
                  ● GPS Active
                </span>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-[10px] font-mono text-amber-700 dark:text-amber-400 font-bold mt-1">
                          {opt.badge}
                        </div>
                      </div>
                    </button>
            ...
            <div className="space-y-4 pt-6 sm:pt-7 border-t border-slate-100 dark:border-slate-800">
              <label className="block text-xs sm:text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider font-mono flex items-center gap-2.5">
                <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center text-xs font-black shadow-xs">2</span>
                <span>Vehicle Identification:</span>
              </label>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div>
                  <label className="block text-slate-600 dark:text-slate-400 text-xs font-bold mb-1.5">Make / Model</label>
                  <input
                    type="text"
                    value={vehicleBrand}
                    onChange={(e) => setVehicleBrand(e.target.value)}
                    placeholder="e.g. Honda Civic or Royal Enfield"
                    className="w-full clean-input px-4 py-3.5 text-sm font-bold"
                  />
                </div>
                <div>
                  <label className="block text-slate-600 dark:text-slate-400 text-xs font-bold mb-1.5">License Plate Number</label>
                  <input
                    type="text"
                    value={vehiclePlate}
                    onChange={(e) => setVehiclePlate(e.target.value)}
                    placeholder="e.g. CA-8XYZ92"
                    className="w-full clean-input px-4 py-3.5 text-sm font-mono font-black uppercase tracking-wider"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-6 sm:pt-7 border-t border-slate-100 dark:border-slate-800">
              <label className="block text-xs sm:text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider font-mono flex items-center gap-2.5">
                <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center text-xs font-black shadow-xs">3</span>
                ...
                {problemOptions.map((opt) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-4 sm:p-5 rounded-2xl border-2 text-left transition-all flex items-start gap-4 ${
                        isSelected
                    ...
                    >
                      <div className={`p-2.5 rounded-xl ${isSelected ? 'bg-orange-500 text-white' : 'bg-slate-100 dark:bg-slate-800 text-slate-500'}`}>
            ...
            <div className="space-y-4 pt-6 sm:pt-7 border-t border-slate-100 dark:border-slate-800">
              <label className="block text-xs sm:text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider font-mono flex items-center gap-2.5">
                <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center text-xs font-black shadow-xs">4</span>
                ...
                {urgencyOptions.map((urg) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-[11px] text-slate-500 dark:text-slate-400 mt-1 font-medium">{urg.desc}</div>
                    </button>
                  );
                })}
              </div>
            ...
            <div className="space-y-3 pt-6 sm:pt-7 border-t border-slate-100 dark:border-slate-800">
              <label className="block text-xs sm:text-sm font-black text-slate-900 dark:text-white uppercase tracking-wider font-mono flex items-center gap-2.5">
                <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-900 flex items-center justify-center text-xs font-black shadow-xs">5</span>
            ...
            <div className="p-5 sm:p-6 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2.5 my-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase font-mono tracking-wider">
                  Current GPS Locked Coordinates
                </span>
                <span className="text-xs font-mono text-emerald-700 dark:text-emerald-300 font-bold bg-emerald-100 dark:bg-emerald-950/80 px-3 py-1 rounded border border-emerald-200 dark:border-emerald-800">
                  ● Telemetry Verified
                </span>
              </div>
              <p className="text-sm sm:text-base font-bold text-slate-900 dark:text-white flex items-center gap-2.5">
        ...
        {/* 2. SEARCHING STAGE */}
        {stage === 'SEARCHING' && (
          <div className="clean-card emergency-card-active p-8 sm:p-12 text-center space-y-7 shadow-xl rounded-3xl animate-in fade-in duration-200 border-2 border-orange-300 dark:border-orange-800">
            ...
            <div className="p-5 bg-white/90 dark:bg-slate-900/90 rounded-2xl inline-flex flex-wrap items-center justify-center gap-3.5 text-xs font-mono text-slate-800 dark:text-slate-200 border border-orange-200 dark:border-orange-800 shadow-sm">
            ...
            <div className="pt-4">
              <button
                ...
                className="btn-secondary py-3 px-6 text-xs font-bold rounded-xl"
              >
                Cancel SOS Request
              </button>
            </div>
        ...
        {stage === 'ACCEPTED' && (
          <div className="clean-card p-7 sm:p-10 space-y-7 border-l-4 border-l-emerald-600 animate-in fade-in duration-200 shadow-xl rounded-3xl bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800">
            {/* Acceptance Banner */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 border-b border-slate-100 dark:border-slate-800 pb-6">
              <div className="space-y-2">
                <span className="px-3.5 py-1.5 rounded-full text-xs font-bold bg-emerald-100 dark:bg-emerald-950/80 text-emerald-800 dark:text-emerald-300 inline-flex items-center gap-2 shadow-2xs border border-emerald-200 dark:border-emerald-800">
              ...
              <div className="text-left sm:text-right bg-gradient-to-br from-indigo-50 to-orange-50 dark:from-slate-800 dark:to-slate-800/80 px-6 py-4 rounded-2xl border border-indigo-100 dark:border-slate-700 self-start sm:self-auto shadow-sm">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span className="text-3xl sm:text-4xl font-black font-mono text-indigo-700 dark:text-indigo-400">{liveETA}</span>
                  <span className="text-xs font-mono font-bold text-orange-600 dark:text-orange-400 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-lg border border-orange-200 dark:border-orange-800">
                    {liveDistance}
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 p-3.5 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700 text-xs">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <button
                    type="button"
                    onClick={handleResetSos}
                    className="px-3.5 py-2 bg-rose-50 dark:bg-rose-950/60 text-rose-700 dark:text-rose-300 hover:bg-rose-100 rounded-xl font-bold border border-rose-200 dark:border-rose-800"
                  >
                    New Request
                  </button>
                </div>
            ...
            {/* Status & Driver Card */}
            <div className="p-6 bg-indigo-50/90 dark:bg-slate-800/90 rounded-2xl border-2 border-indigo-200 dark:border-slate-700 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
              <div>
                <p className="text-base sm:text-lg font-black text-indigo-950 dark:text-indigo-200 flex items-center gap-2">
              ...
              <a
                ...
                className="btn-primary w-full sm:w-auto px-7 py-4 text-sm font-black flex items-center justify-center gap-2.5 shadow-md whitespace-nowrap"
              >
